// Documentation: https://www.npmjs.com/package/google-calendar
...
Acl.prototype.get = function(calendarId, ruleId, callback) {
    ...
    this.request('GET', '/calendars/' + calendarId + '/acl/' + ruleId, {}, {}, null, callback);
}

Acl.prototype.insert = function(calendarId, acl, callback) {
    calendarId = encodeURIComponent(calendarId);

    this.request('POST', '/calendars/' + calendarId + '/acl', {}, {}, acl, callback);
}

Acl.prototype.list = function(calendarId, callback) {
    calendarId = encodeURIComponent(calendarId);

    this.request('GET', '/calendars/' + calendarId + '/acl', {}, {}, null, callback);
}
...
Acl.prototype.update = function(calendarId, ruleId, acl, callback) {
    ...
    this.request('PUT', '/calendars/' + calendarId + '/acl/' + ruleId, {}, {}, acl, callback);
}
...
Acl.prototype.patch = function(calendarId, ruleId, acl, callback) {
    ...
    this.request('PATCH', '/calendars/' + calendarId + '/acl/' + ruleId, {}, {}, acl, callback);
}
...
Events.prototype.stopWatch = function(stop_request, callback) {
    ...
    this.request('POST', '/channels/stop', {}, {}, stop_request, callback);
}
...
Settings.prototype.list = function(callback) {
    ...
    this.request('GET', '/users/me/settings', {}, {}, null, callback);
}

Settings.prototype.get = function(setting, callback) {
    setting = encodeURIComponent(setting)

    this.request('GET', '/users/me/settings/' + setting, {}, {}, null, callback);
}